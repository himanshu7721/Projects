...
public class Client implements ActionListener{
    ...
    p1.setBounds(0,0,600,70);//To get jpanel element at top
      ...
      JLabel  l1=new JLabel(img2);
       ...
       l1.addMouseListener(new MouseAdapter()
        ...
        ImageIcon img3=new ImageIcon(ClassLoader.getSystemResource("chatting/application/icons/2.png"));
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            s=new Socket("127.0.0.1",4000);//ip address of local host
